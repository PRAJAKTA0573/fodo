...
/// NGO registration page with comprehensive organization form
...
class _NgoRegisterPageState extends State<NgoRegisterPage> {
  ...
  String _registrationType = 'Trust';
  ...
  Future<void> _handleRegistration() async {
    ...
    if (authProvider.errorMessage == null && mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'NGO registration submitted! Your application is under review.',
          ),
          ...
          children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const AuthSectionHeader(
                      ...
                      subtitle: 'Tell us about your NGO',
                    ),
                    const SizedBox(height: 16),
                    ...
                    AuthTextField(
                      ...
                      validator: (value) =>
                          value?.isEmpty ?? true ? 'NGO name is required' : null,
                    ),
                    const SizedBox(height: 16),
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: const [
                        ...
                        DropdownMenuItem(value: '80G', child: Text('80G')),
                        DropdownMenuItem(value: '12A', child: Text('12A')),
                        DropdownMenuItem(
                          value: 'Section 8',
                          child: Text('Section 8 Company'),
                        ),
                      ],
                      onChanged: (value) {
                        setState(() {
                          _registrationType = value ?? 'Trust';
                        });
                      },
                    ),
                    const SizedBox(height: 16),
                    ...
                    const AuthSectionHeader(
                      ...
                      subtitle: 'Who should we contact for coordination?',
                    ),
                    const SizedBox(height: 16),
                    ...
                    AuthTextField(
                      ...
                      label: 'Designation',
                      hint: 'Director, Manager, Coordinator, etc.',
                    ...
                    const AuthSectionHeader(
                      ...
                      subtitle: 'Where is your NGO located?',
                    ),
                    const SizedBox(height: 16),
                    ...
                    AuthTextField(
                      ...
                      label: 'Service Areas',
                      hint: 'Cities/areas you serve (comma-separated)',
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'You will be able to upload verification documents (registration certificate, 80G, etc.) after creating your account.',
                              style: TextStyle(
                                fontSize: 13,
                      ...
                      children: [
                        ...
                        Expanded(
                          child: GestureDetector(
                            ...
                            child: const Text(
                              'I agree to the Terms & Conditions and certify that all provided information is accurate',
            ...
            if (authProvider.isLoading)
              const AuthLoadingOverlay(
                message: 'Submitting your NGO application...',
              ),
          ],
        ),
      ),
